...
class DatasetType(TypedDict):
    ...
    Example::

        {
            ...
            'updated': datetime.datetime(2020, 1, 1, 0, 15, tzinfo=<UTC+01:00>)
...
class DatasetResponse(TypedDict):
    ...
    Attributes:
        ...
        size: The size of the content in number of bytes.
        thing_uuid: A UUID reference to a Thing as a way to track data-sets to things.
        created: Date-time string when created, as defined by RFC 3339, section 5.6.
        created_by: User UUID reference.
        updated: Date-time string of last change, as defined by RFC 3339, section 5.6.
        updated_by: User UUID reference.
        tags: Tags pinned on this dataset.
